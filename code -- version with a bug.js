...
function startGame(){ // function to start the game after the button is pressed
    ...
    // for the bug, i removed the part that disables the start button. this allows the player to keep pressing the button, making the timer go negative.
    // this also causes the answer buttons to be disabled as well, while the timer just keeps constantly going negative after the player presses the start button a bunch of times in a row.
